...
| [flutter-mobile-beta-release-handoff](skills/flutter-mobile-beta-release-handoff/SKILL.md) | Creates a reliable Flutter beta release handoff for Android Firebase App Distribution and iOS TestFlight. Use when building, uploading, or summarizing beta artifacts so release status, hashes, upload IDs, tester distribution, and follow-up gaps are explicit. | Prepare a beta release handoff for my Flutter app after uploading Android to Firebase App Distribution and iOS to TestFlight |
